...
```
python python get_mAP.py test -d [path-to-result-folder] -c 19 --arch drn_d_22 \
--phase val --batch-size 1 --pretrained [path-to-pretrained-drn]
python get_Acc.py --gt_path [path-to-result-folder]/images/real_A \
--output_path [path-to-result-folder]/segmapResult_color
```
